...
class LibsFragment : Fragment() {
    ...
    private lateinit var viewModelFactory: LibsViewModelFactory
    private lateinit var titleList: List<String>
    private val viewModel: LibsViewModel by viewModels { viewModelFactory }
    ...
    override fun onCreateView(
        ...
        viewModelFactory = LibsViewModelFactory(mAppDatabase.libsDao())
